...
PACKAGEDATA = {
    ...
    'package_dir': {'byte': 'byte',
                   },
    'packages': ['byte',
                ],
    'scripts': ['scripts/byte'],
}
...
_DATA_DIR = os.path.join('byte', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'byte': data_dirs}
